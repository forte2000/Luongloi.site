          ...
          <div className='hidden md:block md:pl-12 lg:pl-28 xl:pl-32'>
            ...
            <div className='p-4 mt-4 rounded-lg border-[2px] bg-slate-100 border-slate-200'>
              ...
              <div className='flex mt-6 gap-3 items-center'>
                ...
                <div className='flex-1'>
                  <h5 className='text-sm'>Đại Học Bách Khoa Hà Nội ( Hust )</h5>
                  <div className='flex justify-between text-xs text-slate-700'>
                    <p>Oh no My Dream~~</p>
                    <p>201x - 202x</p>
                  </div>
              ...
              <div className='mt-6'>
                <a href='https://hust.edu.vn/' className='w-full py-2 flex text-sm hover:bg-slate-700 items-center gap-2 justify-center text-slate-100 bg-slate-800 rounded-lg'>
                  <span>
