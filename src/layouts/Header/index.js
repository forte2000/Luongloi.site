...
import { faClockRotateLeft, faEnvelope, faHeart, faPhoneFlip } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className='p-5 md:rounded-xl bg-white shadow-sm text-neutral-800'>
      ...
      <div className='flex mt-4 gap-2 text-xl'>
        ...
        <Tippy animation='scale' content='Locket'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-200 size-[38px] items-center flex justify-center hover:bg-cyan-500' href='https://locket.camera/links/fBbj9tVfzNjJ2zQh8'>
